...
<body class="w3-light-grey">
  ...
  <nav class="w3-sidebar w3-bar-block w3-black w3-animate-right w3-top w3-text-light-grey w3-large"
    ...
    <a href="http://localhost/TubesTekWeb/index.php/User/" onclick="w3_close()"
      class="w3-bar-item w3-button w3-center w3-padding-16">HALAMAN AWAL</a>
  ...
  ?>
    ...
    <footer class="w3-container w3-padding-32 w3-grey">
      <div class="w3-row-padding">
        <div class="w3-half">
          <h3>INFO</h3>
          <p>Kami tidak menyediakan tempat untuk membeli produk, melainkan hanyalah menampilkan katalog produk-produk
            rekanan kami.</p>
        </div>
        ...
        <div class="w3-half">
          <h3>TAG POPULER</h3>
          <p>
            <span class="w3-tag w3-black w3-margin-bottom">Tren terkini</span> <span
              class="w3-tag w3-dark-grey w3-small w3-margin-bottom">Mantel</span> <span
              class="w3-tag w3-dark-grey w3-small w3-margin-bottom">Cardigan</span>
            <span class="w3-tag w3-dark-grey w3-small w3-margin-bottom">Sweater</span> <span
